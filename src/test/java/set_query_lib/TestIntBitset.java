...
public class TestIntBitset {
  ...
  public void testLocalDistance(){
    ...
    assertEquals(IntBitSet.localDistance(bstA, bstB), 2);
    assertEquals(IntBitSet.localDistance(bstC, bstD), 1);
    assertEquals(IntBitSet.localDistance(bstE, bstF), 3);
    assertEquals(IntBitSet.localDistance(bstF, bstG), 0);
  }
  ...
  public void testWeight(){
    ...
    assertEquals((int) bstA.weight(weights), 101001);
    assertEquals((int) bstB.weight(weights), 100110);
    assertEquals((int) bstC.weight(weights), 101101);
  }

  @Test
  public void testWeightedLocalDistance(){
    ...
    assertEquals((int) IntBitSet.weightedLocalDistance(bstA, bstB, weights), 1001);
    assertEquals((int) IntBitSet.weightedLocalDistance(bstC, bstD, weights), 1);
    assertEquals((int) IntBitSet.weightedLocalDistance(bstE, bstF, weights), 101001);
    assertEquals((int) IntBitSet.weightedLocalDistance(bstF, bstG, weights), 0);
  }
  ...
  public void testWeightedDistance(){
    ...
    assertEquals((int) IntBitSet.weightedDistance(bstA, bstB, weights), 1111);
    assertEquals((int) IntBitSet.weightedDistance(bstC, bstD, weights), 11);
    assertEquals((int) IntBitSet.weightedDistance(bstA, bstA, weights), 0);
    assertEquals((int) IntBitSet.weightedDistance(bstF, bstG, weights), 100000);
    assertEquals((int) IntBitSet.weightedDistance(bstG, bstF, weights), 100000);
    assertEquals((int) IntBitSet.weightedDistance(bstA, bstE, weights), 110);
  }
